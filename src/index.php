...
define("PRODUCTION_KEY", $_ENV['PRODUCTION_KEY']);
define("PRODUCTION_PASS", $_ENV['PRODUCTION_PASS']);
...
function createPWSSOAPClient()
{
  ...
  **/
  ...
  $client = new SoapClient( "./wsdl/FreightShippingService.wsdl",
                            array	(
					'trace'			=>	true,
...
$request->Shipment->SenderInformation->EmailAddress="YOUR EMAIL ADDRESS";
...
$request->Shipment->ReceiverInformation->EmailAddress="YOUR EMAIL ADDRESS";
...
$request->Shipment->ShipmentDetails->AccessorialParameters->BoolValuePair->Keyword="2MEN";
$request->Shipment->ShipmentDetails->AccessorialParameters->BoolValuePair->Value="true";
...
$request->Shipment->AlertInformation->AlertDetails->AlertDetail->EmailAddress="YOUR EMAIL ADDRESS";
